...
import sg.flooringmastery.dto.State;

/**
 *
 * @author crouton
 */
public class TestDaoImpl implements Dao{
    
    private static final String DELIMITER = ",";
    private static final String PRODUCT_FILE = "Data/Products.txt";
    private static final String STATE_FILE = "Data/States.txt";
    private static final String EXPORT_FILE = "TestBackup/DataExport.txt";
    ...
    public Order createOrder(String date, String name, String state, String productType, String area)
        ...
        }catch(FileNotFoundException e){//Means this order is the first for that date
    ...
    private String marshallOrder(Order order){
        String orderInfo = String.valueOf(order.getOrderNumber()) + DELIMITER;//state name tax
    ...
    private void writeAllOrders(String date) throws IOException{
        String fileName = "TestOrders/Orders_";
